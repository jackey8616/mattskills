...
- **OpenSpec** — skipped entirely when `openspec/` is already there. Otherwise it offers `openspec init`, because [to-spec](https://aihero.dev/skills-to-spec), [to-tickets](https://aihero.dev/skills-to-tickets) and [change-review](https://aihero.dev/skills-change-review) write into the spec layer and stop rather than putting specs somewhere else. Decline and those three stay unavailable — there is no fallback to configure.
